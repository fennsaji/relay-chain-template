...
pub use relay_template_test_runtime as runtime;
pub use relay_template_test_service::{
...
impl substrate_test_client::GenesisInit for GenesisParameters {
	fn genesis_storage(&self) -> Storage {
		relay_template_test_service::chain_spec::polkadot_local_testnet_genesis()
			.build_storage()
