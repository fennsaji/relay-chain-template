...
use relay_template_service::chain_spec::{
	get_account_id_from_seed, get_from_seed, polkadot_chain_spec_properties, Extensions,
};
use relay_template_test_runtime::BABE_GENESIS_EPOCH_CONFIG;
...
pub type PolkadotChainSpec =
	sc_service::GenericChainSpec<relay_template_test_runtime::GenesisConfig, Extensions>;
...
pub fn polkadot_local_testnet_genesis() -> relay_template_test_runtime::GenesisConfig {
...
) -> relay_template_test_runtime::GenesisConfig {
	use relay_template_test_runtime as runtime;
